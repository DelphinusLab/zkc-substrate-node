...
#[test]
fn multi_supplier_multi_swap_cannot_retrieve_all_swap_after_supply() {
    new_test_ext().execute_with(|| {
        ...
        //PoolRetrieve amount0 996 and amount1 1003 for poolIndex 0, caller is accountIndex 2
        amount0 = U256::from(996);
        ...
        assert_eq!(PoolMap::get(pool_index).unwrap(), (0u32, 1u32, U256::from(499), U256::from(504), U256::from(500_668_896_321_070_234u128)));

        assert_eq!(BalanceMap::get((&account_index, 0u32)), U256::from(2001));

        assert_eq!(BalanceMap::get((&account_index, 1u32)), U256::from(1996));

        assert_eq!(ShareMap::get((&account_index, &pool_index)), U256::from(668_896_321_070_234u128));

        assert_eq!(NonceMap::<Test>::get(2u64), 5u64);

        //PoolRetrieve amount0 498 and amount1 501 for poolIndex 0, caller is accountIndex 3
        origin = 3u64;
        account_index = 3u32;
        amount0 = U256::from(498);
        ...
        assert_eq!(PoolMap::get(pool_index).unwrap(), (0u32, 1u32, U256::from(1), U256::from(3), U256::from(1_003_344_481_605_351u128)));

        assert_eq!(BalanceMap::get((&account_index, 0u32)), U256::from(1998));

        assert_eq!(BalanceMap::get((&account_index, 1u32)), U256::from(2001));

        assert_eq!(ShareMap::get((&account_index, &pool_index)), U256::from(334_448_160_535_117u128));

        assert_eq!(NonceMap::<Test>::get(3u64), 3u64);

        //PoolRetrieve amount0 1 and amount1 1 for poolIndex 0, caller is accountIndex 2
        //Token0 belongs to accountIndex 2 less than 1
        origin = 2u64;
        account_index = 2u32;
        amount0 = U256::from(1);
        amount1 = U256::from(1);
        ...
        //PoolRetrieve amount0 1 and amount1 1 for poolIndex 0, caller is accountIndex 3
        //Token0 belongs to accountIndex 3 less than 1
        origin = 3u64;
        account_index = 3u32;
        amount0 = U256::from(1);
        amount1 = U256::from(1);
...
#[test]
fn multi_supplier_multi_swap_cannot_retrieve_all_swap_not_after_supply() {
    new_test_ext().execute_with(|| {
        //SetKey for accountIndex 0
        let mut origin = 0u64;
        let pub_key_0: [u8; 32] = [
        ...
        //Swap amount 1000 from tokenIndex1 to tokenIndex0 for poolIndex 0, caller is accountIndex 0, reverse is 1
        origin = 0u64;
        account_index = 0u32;
        let mut reverse = 1u8;
        ...
        //Swap amount 2000 from tokenIndex0 to tokenIndex1 for poolIndex 0, caller is accountIndex 0, reverse is 0
        reverse = 0u8;
        amount = U256::from(2000);
        nonce = 2u64;
        ...
        //PoolSupply amount0 2000 and amount1 325 for poolIndex 0, caller is accountIndex 3
        //AccountIndex 3 supply after swap
        origin = 3u64;
        account_index = 3u32;
        amount0 = U256::from(2000);
        amount1 = U256::from(325);
        nonce = 1u64;
        let secret_key_3 = [
            8, 123, 229, 206, 38, 143,  38, 167,
            240, 190,  94,  53, 94, 181, 177, 226,
        ...
        //PoolRetrieve amount0 1735 and amount1 376 for poolIndex 0, caller is accountIndex 3
        origin = 3u64;
        account_index = 3u32;
        amount0 = U256::from(1735);
        amount1 = U256::from(376);
        nonce = 2u64;
        ...
        assert_eq!(PoolMap::get(pool_index).unwrap(), (0u32, 1u32, U256::from(2174), U256::from(472), U256::from(1_000_718_790_534_213_713u128)));

        assert_eq!(BalanceMap::get((&account_index, 0u32)), U256::from(1735));

        assert_eq!(BalanceMap::get((&account_index, 1u32)), U256::from(2051));

        assert_eq!(ShareMap::get((&account_index, &pool_index)), U256::from(718_790_534_213_713u128));

        assert_eq!(NonceMap::<Test>::get(3u64), 3u64);

        //PoolRetrieve amount0 2172 and amount1 471 for poolIndex 0, caller is accountIndex 2
        origin = 2u64;
        account_index = 2u32;
        amount0 = U256::from(2172);
        amount1 = U256::from(471);
        nonce = 2u64;
        ...
        assert_eq!(PoolMap::get(pool_index).unwrap(), (0u32, 1u32, U256::from(2), U256::from(1), U256::from(920_624_462_312_984u128)));

        assert_eq!(BalanceMap::get((&account_index, 0u32)), U256::from(3172));

        assert_eq!(BalanceMap::get((&account_index, 1u32)), U256::from(1471));

        assert_eq!(ShareMap::get((&account_index, &pool_index)), U256::from(201_833_928_099_271u128));

        assert_eq!(NonceMap::<Test>::get(2u64), 3u64);

        //PoolRetrieve amount0 1 and amount1 0 for poolIndex 0, caller is accountIndex 2
        //Token0 belongs to accountIndex 2 less than 1
        amount0 = U256::from(1);
        amount1 = U256::from(0);
        nonce = 3u64;
