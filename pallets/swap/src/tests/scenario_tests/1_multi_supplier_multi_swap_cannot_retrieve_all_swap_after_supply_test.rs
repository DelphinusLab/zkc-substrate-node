...
#[test]
//A supply, B supply, multi-swap , A retrieve, B retrieve
fn multi_supplier_multi_swap_cannot_retrieve_all_swap_after_supply() {
    new_test_ext().execute_with(|| {
        ...
        //PoolRetrieve amount0 498 and amount1 502 for poolIndex 0, caller is accountIndex 3
        origin = 3u64;
        account_index = 3u32;
        amount0 = U256::from(498);
        amount1 = U256::from(502);
        nonce = 2u64;
        ...
        assert_eq!(PoolMap::get(pool_index).unwrap(), (0u32, 1u32, U256::from(1), U256::from(2), U256::from(1_003_344_481_605_351u128)));

        assert_eq!(BalanceMap::get((&account_index, 0u32)), U256::from(1998));

        assert_eq!(BalanceMap::get((&account_index, 1u32)), U256::from(2002));

        assert_eq!(ShareMap::get((&account_index, &pool_index)), U256::from(334_448_160_535_117u128));

        assert_eq!(NonceMap::<Test>::get(3u64), 3u64);

        //PoolRetrieve amount0 1 and amount1 2 for poolIndex 0, caller is accountIndex 2
        ...
        //PoolRetrieve amount0 1 and amount1 2 for poolIndex 0, caller is accountIndex 3
