...
#[test]
fn multi_supplier_multi_swap_retrieve_all_works() {
    new_test_ext().execute_with(|| {
		...
		//Swap amount 93 from tokenIndex1 to tokenIndex0 for poolIndex 0, caller is accountIndex 2, reverse is 0
        reverse = 0u8;
        amount = U256::from(93);
        nonce = 3u64;
        ...
        //PoolRetrieve amount0 1000 and amount1 1001 for poolIndex 0, caller is accountIndex 2
        amount0 = U256::from(1000);
        amount1 = U256::from(1001);
        nonce = 4u64;
        ...
        //PoolRetrieve amount0 500 and amount1 501 for poolIndex 0, caller is accountIndex 3
        origin = 3u64;
        account_index = 3u32;
        amount0 = U256::from(500);
