...
fn pool_retrieve_works() {
    new_test_ext().execute_with(|| {
        ...
        assert_eq!(PoolMap::get(pool_index).unwrap(), (0u32, 1u32, U256::from(500), U256::from(500), U256::exp10(ORDER_OF_MAGNITUDE)));

        assert_eq!(BalanceMap::get((&account_index, 0u32)), U256::from(1500));

        assert_eq!(BalanceMap::get((&account_index, 1u32)), U256::from(1500));

        assert_eq!(ShareMap::get((&account_index, pool_index)), U256::from(999_999_999_998_000u64));
