...
fn nft_works() {
	new_test_ext().execute_with(|| {
        // public key
        let mut path = "./src/config/pk.json";
        ...
        path = "./src/config/deposit1_1.json";
        ...
        path = "./src/config/deposit1_2.json";
        file = match File::open(path) {
            Ok(file) => file,
            Err(e) => {
                println!("open failed: {}", e);
        ...
        path = "./src/config/deposit_nft_1.json";
        file = match File::open(path) {
            Ok(file) => file,
            Err(e) => {
                println!("open failed: {}", e);
        ...
        path = "./src/config/deposit_nft_2.json";
        file = match File::open(path) {
            Ok(file) => file,
            Err(e) => {
                println!("open failed: {}", e);
        ...
        nonce = 1u64;
        path = "./src/config/deposit2_1.json";
        file = match File::open(path) {
            Ok(file) => file,
            Err(e) => {
                println!("open failed: {}", e);
        ...
        path = "./src/config/deposit2_2.json";
        file = match File::open(path) {
            Ok(file) => file,
            Err(e) => {
                println!("open failed: {}", e);
        ...
        nonce = 2u64;
        amount = U256::from(1);
        path = "./src/config/bid_nft_1.json";
        file = match File::open(path) {
            Ok(file) => file,
            Err(e) => {
                println!("open failed: {}", e);
        ...
        path = "./src/config/bid_nft_2.json";
        file = match File::open(path) {
            Ok(file) => file,
            Err(e) => {
                println!("open failed: {}", e);
        ...
        nonce = 3u64;
        let recipient = 3u32;
        path = "./src/config/transfer_nft_1.json";
        file = match File::open(path) {
            Ok(file) => file,
            Err(e) => {
                println!("open failed: {}", e);
        ...
        path = "./src/config/transfer_nft_2.json";
        file = match File::open(path) {
            Ok(file) => file,
            Err(e) => {
                println!("open failed: {}", e);
        ...
        origin = 3u64;
        nonce = 1u64;
        path = "./src/config/finalize_nft_1.json";
        file = match File::open(path) {
            Ok(file) => file,
            Err(e) => {
                println!("open failed: {}", e);
        ...
        path = "./src/config/finalize_nft_2.json";
        file = match File::open(path) {
            Ok(file) => file,
            Err(e) => {
                println!("open failed: {}", e);
        ...
        nonce = 3u64;
        path = "./src/config/withdraw_nft_1.json";
        file = match File::open(path) {
            Ok(file) => file,
            Err(e) => {
                println!("open failed: {}", e);
        ...
        path = "./src/config/withdraw_nft_2.json";
        file = match File::open(path) {
            Ok(file) => file,
            Err(e) => {
                println!("open failed: {}", e);
